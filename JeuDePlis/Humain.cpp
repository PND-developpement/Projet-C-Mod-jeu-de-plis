...
//méthodes rédéfinies
std::shared_ptr<CarteInterface> Humain::JouerUneCarte(const Interface& interface, std::string parametre)
{
	int positionCarte = interface.DemanderCarte(*cartes, pseudo,parametre);
